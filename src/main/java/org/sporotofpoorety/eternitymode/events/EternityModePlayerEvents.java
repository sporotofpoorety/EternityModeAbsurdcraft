...
/*
                event.player.sendMessage
                    (new TextComponentString("§cUNREMARKABLE, THE DEATH OF A NOBODY. UNREMARKABLE, PITIFUL FAILURE. UNREMARKABLE, ABSURD PUNCHLINE. SO DULY DELIVERED - A TIRED BEAT. MY MASTERWORKS SHALL EULOGIZE YOU WITH THE DEAREST OF THANKS, FOR SHOWING THAT MY THESIS REMAINS DEVASTATINGLY SUPERIOR. PERFECT CASE STUDY ON THE WRETCHED DESTINY OF YOUR KIND."));
*/
            }
        }
