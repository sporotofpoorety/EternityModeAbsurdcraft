...
public class Tessellator2 
{
    ...
    private int normal;
    public static final Tessellator2 instance;
    ...
    private Tessellator2(int bufferSize) 
    {
    }
    ...
    public TesselatorVertexState getVertexState(float p_147564_1_, float p_147564_2_, float p_147564_3_) 
    {
        ...
        for(int var10 = 0; !priorityqueue.isEmpty(); var10 += b0) 
        {
            int j = (Integer)priorityqueue.remove();

            for(int k = 0; k < b0; ++k) 
            {
                aint[var10 + k] = this.rawBuffer[j + k];
            }
        }
    ...
    static 
    {
        ...
        instance = new Tessellator2(2097152);
