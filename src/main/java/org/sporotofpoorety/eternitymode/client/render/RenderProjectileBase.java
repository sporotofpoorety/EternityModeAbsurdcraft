...
public class RenderProjectileBase<T extends Entity> extends Render<T> {
	...
	public RenderProjectileBase(RenderManager renderManager, float scale, ResourceLocation texture, boolean doBlending){
		super(renderManager);
		this.scale = scale;
	...
	@Override
	public void doRender(T entity, double par2, double par4, double par6, float par8, float par9){
